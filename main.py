from flask import Flask, flash, request, jsonify, send_file,send_from_directory, url_for, current_app
import os
import subprocess
...
# Make sure your app runs on the provided port
if __name__ == '__main__':
    try:
        port = int(os.environ.get('PORT', 8000))  # Change default to 8000
